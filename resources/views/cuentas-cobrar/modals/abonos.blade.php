<!-- Central Modal Small -->
<div class="modal fade" id="modalIngresoAbonos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    ...
    <div class="modal-dialog modal-xl" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white ">
                <h4 class="modal-title font-weight-bold" id="myModalLabel">Ingreso de abonos</h4>
