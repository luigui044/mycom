 <!-- Central Modal Small -->
 <div class="modal fade" id="modalCatalogoBancos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
     ...
     <div class="modal-dialog modal-lg" role="document">
         ...
         <div class="modal-content">
             <div class="modal-header">
                 <h4 class="modal-title w-100" id="myModalLabel">Catálogos de bancos</h4>
                     ...
                     <form action="" method="POST">
                         ...
                         <div class="row">
                             <div class="col-md-6 form-group">
                                 <label for="email">Nombre de del banco:</label>
                                 <input class="form-control form-control-sm" type="text" id="nombre"
                                     name="nombre">
                             </div>
                             <div class="col-md-6 form-group">
                                 <label for="direccion">Dirección:</label>
                                 <textarea class="form-control form-control-sm" type="text" id="direccion" rows="2" name="direccion"> </textarea>
                             </div>
                             <div class="col-md-6 form-group">
                                 <label for="telefono">Contacto:</label>
                                 <input class="form-control form-control-sm" type="text" id="telefono"
                                     name="telefono">
                             </div>
                             <div class="col-md-6 form-group">
                                 <label for="formato">Número de formato para generar archivo:</label>
                                 <select class="browser-default custom-select form-control-sm" id="formato"
                                     name="formato">
